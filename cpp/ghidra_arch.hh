...
class ArchitectureGhidra : public Architecture {
  ...
  bool sendPsuedoCode;		///< True if final psuedocode should be sent with function output
...
public:
  ...
  void setSendPsuedoCode(bool val) { sendPsuedoCode = val; }

  bool getSendPsuedoCode(void) const { return sendPsuedoCode; }		///< Get the current setting for emitting source code
